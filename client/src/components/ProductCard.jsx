    ...
    return (
        <div className={` ${width} h-fit p-2  rounded cursor-pointer hover:bg-[#222] transition-smooth max-lg:w-[40vw] max-lg:shrink-0`} key={product._id}>
            ...
            <div className='w-full h-fit pt-2 lg:pt-5 '>
                <h1 className='font-subheading tracking-wide text-white/90 text-[4vw] md:text-2xl lg:text-[19px] uppercase'>
                ...
                <p className='text-base tracking-wider font-body text-yellow-400/80 uppercase pt-5 lg:pt-10'>&#x20B9; {product.price}</p>
