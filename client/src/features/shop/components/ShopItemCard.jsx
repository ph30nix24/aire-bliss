...
const ShopItemCard = ({ product, width, height }) => {
    ...
    return (
        <div className={` ${width} h-fit ${height} lg:flex lg:flex-col lg:justify-between p-2  rounded cursor-pointer hover:bg-[#222] transition-smooth  max-lg:shrink-0 relative`} key={product.productName}>
            <div className='w-full'>
                ...
                <div className='w-full h-fit pt-2 lg:pt-5 '>
                    ...
                    <p className='text-[3vw] lg:text-base text-gray-300 font-body tracking-wider lg:pr-5  font-extralight'>{product.fragranceNotes.join(', ')}</p>
            ...
            <div className='w-full h-fit'>
                ...
                <button className='w-full py-3 lg:py-4 text-yellow-400/90 center gap-3 bg-[#111]/50 hover:text-[#111] border hover:bg-yellow-400/90 mt-3 cursor-pointer transition-smooth' onClick={() => handleAddItemCart(product._id)}>
