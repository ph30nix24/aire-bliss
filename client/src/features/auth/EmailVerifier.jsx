                    ...
                    <div className="w-2/3 h-full flex gap-3">
                        ...
                        <div className='w-[60%] h-full bg-[#17171C] rounded-2xl border border-[#888]/10 shadow-xl p-5 px-10 shadow-lg shadow-[#777]/10'>
                            ...
                            <div className='w-full flex gap-2 my-4 px-5 mt-7'>
                                <input type="number" name="" id="" className="w-1/6 h-14 border border-[#777]/80 rounded [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [appearance:textfield] text-white py-3 text-center text-xl font-subheading focus:outline-none focus:ring focus:ring-[#813A79]"/>
                                <input type="number" name="" id="" className="w-1/6 h-14 border border-[#777]/80 rounded [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [appearance:textfield] text-white py-3 text-center text-xl font-subheading focus:outline-none focus:ring focus:ring-[#813A79]"/>
                                <input type="number" name="" id="" className="w-1/6 h-14 border border-[#777]/80 rounded [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [appearance:textfield] text-white py-3 text-center text-xl font-subheading focus:outline-none focus:ring focus:ring-[#813A79]"/>
                                <input type="number" name="" id="" className="w-1/6 h-14 border border-[#777]/80 rounded [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [appearance:textfield] text-white py-3 text-center text-xl font-subheading focus:outline-none focus:ring focus:ring-[#813A79]"/>
                                <input type="number" name="" id="" className="w-1/6 h-14 border border-[#777]/80 rounded [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [appearance:textfield] text-white py-3 text-center text-xl font-subheading focus:outline-none focus:ring focus:ring-[#813A79]"/>
                            ...
                            <div className='w-full mt-13 px-5 text-white '>
                                <button className='font-body w-full bg-linear-to-b  from-[#9f3592] to-[#7b2771] py-3 rounded-lg cursor-pointer shadow-lg shadow-[#777]/10 outline-none text-sm'>
                                    Verify Email
                                </button>
