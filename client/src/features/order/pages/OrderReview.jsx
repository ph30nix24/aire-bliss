...
const OrderReview = () => {
    ...
    return (
        <main className='bg-[#131313] bg-[radial-gradient(circle_at_50%_0%,#212121_0%,transparent_70%)]'>
            ...
            <div className='w-full h-fit px-35 mb-20'>
                <p className='uppercase text-center text-primary text-xs font-body  tracking-[0.375em] font-bold'>The final correction</p>

                <h1 className='text-center text-white/90 text-7xl max-lg:px-10 lg:text-7xl font-subheading italic capitalize mt-5 '>Review Your <br /> Order</h1>

                <p className='w-full lg:w-180 text-center mx-auto text-base px-5 lg:text-lg font-body font-light mt-10 text-white/50 tracking-wider'>
                    Please review your selections and destination address details before proceeding to payment.
                </p>

                <div className='w-full gap-20 flex py-20'>


                    <div className='w-7/10'>
                        <div className='w-full flex items-center justify-between'>
                            <p className='font-body uppercase tracking-[0.355em] text-xs text-yellow-300/90'>delivery Address</p>
                        ...
                        <div className='w-full flex items-center justify-between mt-20'>
                            <p className='font-body uppercase tracking-[0.355em] text-xs text-yellow-300/90'>Items Selected (3)</p>
                        ...
                        <div className='w-full mt-10'>
                            {bestproducts.slice(2, 5).map((product, index) => (
                                <div className='w-full p-5 flex gap-5 bg-[#181818]/50 backdrop-blur-sm border hover:bg-[#131313]/50 border-[#777]/10 mt-10'>
                                    <img src={`./../../../.${product.img}`} className='size-40' alt="" />

                                    <div className='w-full flex-col justify-between'>
                                        <div className='w-full flex justify-between mt-4'>
                                            <div className=''>
                                                <h1 className='text-3xl italic text-white/80 font-subheading capitalize tracking-wider'>{product.name}</h1>
                                                <p className='font-body text-sm capitalize text-white/50 mt-2'>50ml</p>
                                            </div>
                                            <span className='font-body text-yellow-300/80 tracking-widest text-sm'>&#x20B9;{product.price}</span>
                                        </div>
