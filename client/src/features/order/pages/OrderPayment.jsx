    ...
    <main className='bg-[#131313] bg-[radial-gradient(circle_at_50%_0%,#212121_0%,transparent_70%)]'>
      ...
      <div className='w-full h-fit center gap-5 pt-25 pb-20'>
        ...
        <div className='w-fit flex gap-2 items-end text-yellow-300/80'>
          ...
          <p className='font-body text-lg capitalize font-extralight tracking-widest text-center'>Review</p>
        </div>

        <div className='w-15 h-0.5 bg-linear-to-r from-yellow-300/80 to-yellow-200/10 rounded-full'></div>
        <div className='w-fit flex gap-2 items-end text-yellow-300/80'>
          <p className='font-heading text-base tracking-widest'>04</p>
          <p className='font-body text-lg capitalize font-extralight tracking-widest  text-center border-b-2 pb-1'>payment</p>
        </div>

      </div>

      <div className='w-full px-35 pb-20'>
        <p className='uppercase text-center text-primary text-xs font-body  tracking-[0.375em] font-bold'>The final step</p>
        <h1 className='text-center text-white/90 text-7xl max-lg:px-10 lg:text-7xl font-subheading italic capitalize mt-5 '>Complete Your <br /> Order</h1>

        <p className='w-full lg:w-180 text-center mx-auto text-base px-5 lg:text-base italic font-body font-light mt-10 text-white/50 tracking-wider'>
          Choose your method of transaction to complete your order.
        </p>

        <div className='w-full flex gap-30 mt-20'>
          <div className="w-[65%]">
            <div className='w-full flex items-center justify-between'>
              <p className='font-body uppercase tracking-[0.355em] text-xs text-yellow-300/90'>Select payment method</p>
            </div>
            <div className='w-full my-5 mb-10 h-0.5 bg-linear-to-r from-transparent via-45% to-100% via-yellow-300/10 to-transparent'></div>
            ...
            <div className={`w-full p-10 flex items-start justify-between gap-5  backdrop-blur-sm  text-white/90 relative cursor-pointer transition-smooth  ${selectedPayment === 'online-payment' ? 'border-yellow-300/30 border-2 bg-[#58522e1b] hover:bg-[#58522e21]' : 'border border-[#777]/10 bg-[#131313]/50 hover:bg-[#131313]/70'}`} onClick={() => setSelectedPayment('online-payment')}>
              <div className='w-fit flex gap-5 items-center'>
                ...
                <div className=''>
                  ...
                  <p className='font-body text-sm font-extralight tracking-wider text-white/60 italic'>Pay securely using UPI, Cards, Net Banking <br /> and more.</p>
                </div>
              </div>
              <div className=''>
            ...
            {/* cashOnDelivery */}
            <div className={`w-full p-10 flex items-start justify-between mt-10 transition-smooth gap-5  backdrop-blur-sm  text-white/90 relative cursor-pointer   ${selectedPayment === 'cash-on-delivery' ? 'border-yellow-300/30 border-2 bg-[#58522e1b] hover:bg-[#58522e21]' : 'border border-[#777]/10 bg-[#131313]/50 hover:bg-[#131313]/70'}`} onClick={() => setSelectedPayment('cash-on-delivery')}>
              <div className='w-fit flex gap-5 items-center'>
                ...
                <div className=''>
                  ...
                  <p className='font-body text-sm font-extralight tracking-wider text-white/60 italic pt-1'>Pay in cash when your order is delivered <br /> to you.</p>
                </div>
              </div>
              <div className=''>
            ...
            <div className='w-full p-10 flex items-start justify-between gap-5 bg-[#131313]/50 backdrop-blur-sm border border-[#777]/10 hover:bg-[#131313]/70 text-white/90 mt-10 overflow-hidden'>
              <div className='w-fit'>
                <div className=''>
            ...
            <button className={`w-full px-10 py-5  bg-linear-to-br from-yellow-300/90 to-yellow-400/80 hover:bg-yellow-400 center ${selectedPayment === 'online-payment' && "justify-between!"} gap-3 text-[#111] cursor-pointer transition-smooth mt-10 talic font-medium rounded shadow-lg shadow-yellow-300/20 transition-smooth`}>
              <div className='flex items-center gap-3'>
                {selectedPayment === 'online-payment' ? <CiLock /> : <HiCash />}
                <span className='font-subheading   uppercase tracking-widest'>{selectedPayment === 'online-payment' ? 'Proceed to Payment' : 'Complete Purchase'}</span>
              </div>
              {selectedPayment === 'online-payment' && <span className='font-heading '>&#x20B9; 1087</span>}
            </button>

            {selectedPayment === 'online-payment' && <p className='w-full text-center mx-auto text-base px-5 lg:text-sm italic font-body font-light mt-10 mb-5 text-white/50 tracking-wider'>
              You will be redirected to Razorpay' secure payment page <br /> to complete your transaction.
            </p>}
            ...
            <a href="/checkout/review">
              <button className='w-full py-4 center gap-3 text-white/80 hover:text-yellow-300/80 cursor-pointer transition-smooth mt-3'>
                ...
                <p className='font-body text-sm captialize tracking-[0.125em] font-extralight '>Return to order Review</p>
      ...
      <footer className='w-full py-10 px-20 flex justify-between items-center border-t-2 border-[#777]/10'>
