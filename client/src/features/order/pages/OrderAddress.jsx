        ...
        <main className='bg-[#131313] bg-[radial-gradient(circle_at_50%_0%,#212121_0%,transparent_70%)]'>
            ...
            <div className='w-full h-fit center gap-5 pt-25 pb-20'>
                ...
                <div className='w-fit flex gap-2 items-end text-yellow-300/80'>
                    ...
                    <p className='font-body text-lg capitalize font-extralight tracking-widest  text-center border-b-2 pb-1'>Address</p>
                </div>

                <div className='w-15 h-0.5 bg-linear-to-r from-yellow-300/80 to-yellow-200/10'></div>
                <div className='w-fit flex gap-2 items-end'>
                    <p className='font-heading text-base tracking-widest text-white/40'>03</p>
                    <p className='font-body text-lg capitalize font-extralight tracking-widest  text-center text-white/40'>Review</p>
                </div>
            ...
            <div className='w-full h-fit '>
                <h1 className='text-center text-white/90 text-7xl max-lg:px-10 lg:text-6xl font-subheading italic capitalize '>Select a Delivery <br /> Address</h1>
                <p className='w-full lg:w-180 text-center mx-auto text-base px-5 lg:text-lg font-body font-light mt-10 text-white/50 tracking-wider'>Choose an existing address or add a new one for delivery</p>
