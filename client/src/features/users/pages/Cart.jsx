...
const Cart = () => {
    ...
    return (
        <main className='bg-[#131313]'>
                            ...
                            {isMobile ? (
                                bestproducts.slice(0, 3).map((product, index) => (
                                    <div className='w-full flex gap-3 h-40 mb-8 relative ' key={index}>
                                        <img src={`./../../../../${product.img}`} className='w-30 h-40 lg:h-50 object-cover' alt="" />
                                        ...
                                        <div className='w-[calc(100%-132px)] h-full flex flex-col justify-between relative z-5'>
                                            ...
                                            <div className='w-full h-fit flex justify-between items-center'>
                                                <div className='py-2 px-3 border border-[#777]/40 flex gap-3 items-center'>
                                                    ...
                                                    <p className='font-body text-white/80 text-xs px-2'>1</p>
            ...
            {isMobile ? (
                <footer className='w-full h-fit! p-5 relative z-10 bg-[#1C1B1B]'>
                    
                    <div className='w-full h-fit px-2 rounded-2xl bg-[#222]/20 py-5  center flex-col border-2 border-yellow-600/50 mt-3 mb-5'>
                ...
                <footer className='w-full h-fit! px-30 py-10 relative z-10 bg-[#111]'>
                    <div className='w-full h-fit px-5 rounded-2xl bg-[#222]/20 py-10  center gap-5 border-2 border-yellow-600/50 mb-10'>
