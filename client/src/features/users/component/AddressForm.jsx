    ...
    return (
        <div className='absolute size-full top-0 left-0 bg-black/10 backdrop-blur-md text-white z-51'>
            <div className='w-full h-full lg:h-screen center '>
                <div className='w-9/10 lg:w-200 h-fit p-5 lg:p-10 bg-[#0B0C0C] rounded shadow shadow-yellow-400/10'>
                    {/* heading */}
                    <div className='w-full flex justify-between items-center pb-4 border-b border-[#777]/20'>
                        <div className='flex items-center w-fit gap-5'>
                            <div className=' p-3 rounded-full border-2 border-yellow-400/60'>
                                <MdEditLocationAlt className='text-yellow-400/60 size-4 lg:size-7' />
                            </div>
                            <div className=''>
                                <h1 className='font-heading text-[4.5vw] lg:text-xl'>Add New Address</h1>
                                <p className='text-xs lg:text-sm font-body font-extralight lg:pt-1 text-white/70'>
                    ...
                    <form className='w-full'>
                        ...
                        <div className='w-full flex justify-between gap-2 lg:gap-5 pt-4'>
                            <div className="w-1/2">
                                ...
                                <fieldset className='border px-1.5 lg:px-3 rounded border-[#777]/20 flex items-center gap-1 lg:gap-3'>
                                    ...
                                    <input type="text" name="name" required id="full-name" className='w-full py-2 font-extralight text-xs lg:text-sm px-2 outline-none font-body' placeholder='Enter Full Name' onChange={handleChange} />
                                </fieldset>
                            </div>
                            <div className="w-1/2">
                                ...
                                <fieldset className='border px-1.5 lg:px-3 rounded border-[#777]/20 flex items-center gap-1 lg:gap-3'>
                                    ...
                                    <input type="text" maxLength={10} name="phoneNo" required id="phone-no" placeholder='Enter Moblie Number ' className='w-full py-2 font-extralight text-xs lg:text-sm px-2 outline-none font-body' onChange={handleChange} />
                                </fieldset>
                            </div>
                        ...
                        <div className='w-full flex justify-between gap-2 lg:gap-5 pt-3 lg:pt-4'>
                            <div className="w-full">
                                ...
                                <fieldset className='border px-3 rounded border-[#777]/20 flex items-center gap-3'>
                                    ...
                                    <input type="text" name="addressLine1" required id="house-no" className='w-full py-2 lg:py-3 font-extralight px-2 outline-none font-body text-xs' placeholder='E.g. 123, Green Villa Apartments' onChange={handleChange} />
                                </fieldset>
                            </div>
                        ...
                        <div className='w-full flex justify-between gap-2 lg:gap-5 pt-3 lg:pt-4'>
                            <div className="w-full">
                                ...
                                <fieldset className='border px-3 rounded border-[#777]/20 flex items-center gap-3'>
                                    ...
                                    <input type="text" name="addressLine2" required id="sector" className='w-full py-2 lg:py-3 font-extralight text-xs font-body px-2 outline-none' placeholder='E.g. MG Road, Sector 16' onChange={handleChange} />
                                </fieldset>
                            </div>
                        ...
                        <div className='w-full flex justify-between gap-2 lg:gap-5 pt-3 lg:pt-4'>
                            <div className="w-full">
                                ...
                                <fieldset className='border px-3 rounded border-[#777]/20 flex items-center gap-3'>
                                    ...
                                    <input type="text" name="landmark" id="landmark" className='w-full py-2.5 lg:py-3 font-extralight text-xs px-2 outline-none font-body' placeholder='E.g. Near City Mall, Opposite Metro Station' onChange={handleChange} />
                                </fieldset>
                            </div>
                        ...
                        {/* city, state, pincode */}
                        <div className='w-full flex justify-between gap-2 lg:gap-5 pt-4 max-lg:flex-wrap'>
                        ...
                        <div className='w-full mt-4 '>
                            <button className='w-full center font-body font-light tracking-wider text-xs lg:text-sm bg-yellow-400/60 text-white py-2 rounded cursor-pointer gap-3 hover:bg-yellow-400'>
